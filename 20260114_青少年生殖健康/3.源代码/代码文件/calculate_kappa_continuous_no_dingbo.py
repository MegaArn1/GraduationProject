...
def main():
    ...
    print("Loading Expert Scores (Ding Bo excluded)...")
    experts_scores = {} 
    ...
    output_file = 'kappa_scores_continuous_no_dingbo.xlsx'
    with pd.ExcelWriter(output_file) as writer:
        df_summary.to_excel(writer, sheet_name='Summary', index=False)
        
    print("\n--- Continuous Score Consistency Analysis (Without Ding Bo) ---")
    print(df_summary)
